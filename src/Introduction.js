...
const Introduction = () => (
  <div
    ...
    <p>The process isn't as good as it could be. Tweets have a lot of noise in
      ...
      first several weeks.</p>

    <p>The two hypothesis I wanted to test with this were:</p>
    <ul>
      <li>Is there a distinct increase in positive sentiment on major holidays? Weekends?</li>
      <li>The world appears to be getting more divisive and angry. Is average
        sentiment per day trending downwards?</li>
    </ul>

    <p>For what it's worth, Dec 31/Jan 1 show a distinct peak in the data as of
      writing this.</p>

    <p>This was largely just a toy project to test victoryjs, the new react router
      v4 api, and heroku deployment.</p>
  </div>
)
